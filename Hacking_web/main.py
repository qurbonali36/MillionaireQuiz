...
if 'distutils' not in sys.modules:
    ...
    class LooseVersion:
        ...
        def __eq__(self, other):
            return self.v == other.v if hasattr(other, 'v') else self.v == other
...
def countdown(t):
    ...
    while True:
        if (until - datetime.datetime.now()).total_seconds() > 0:
            stdout.flush()
            stdout.write("\r "+Fore.LIGHTWHITE_EX+"attack status "+Fore.RED+": "+Fore.LIGHTGREEN_EX + str((until - datetime.datetime.now()).total_seconds()) +Fore.LIGHTWHITE_EX+" sec left ")
        else:
            stdout.flush()
            stdout.write("\r "+Fore.MAGENTA+""+Fore.LIGHTWHITE_EX+"attack done!                                   \n")
            return
...
##############################################################################################
def get_info_l7():
    stdout.write("\x1b[38;2;255;20;147m "+Fore.LIGHTWHITE_EX+"url "+Fore.RED+": "+Fore.LIGHTGREEN_EX)
    target = input()
    stdout.write("\x1b[38;2;255;20;147m "+Fore.LIGHTWHITE_EX+"thread "+Fore.RED+": "+Fore.LIGHTGREEN_EX)
    thread = input()
    stdout.write("\x1b[38;2;255;20;147m "+Fore.LIGHTWHITE_EX+"time(s) "+Fore.RED+": "+Fore.LIGHTGREEN_EX)
    t = input()
    return target, thread, t

def get_info_l4():
    stdout.write("\x1b[38;2;255;20;147m "+Fore.LIGHTWHITE_EX+"ip "+Fore.RED+": "+Fore.LIGHTGREEN_EX)
    target = input()
    stdout.write("\x1b[38;2;255;20;147m "+Fore.LIGHTWHITE_EX+"port "+Fore.RED+": "+Fore.LIGHTGREEN_EX)
    port = input()
    stdout.write("\x1b[38;2;255;20;147m "+Fore.LIGHTWHITE_EX+"thread "+Fore.RED+": "+Fore.LIGHTGREEN_EX)
    thread = input()
    stdout.write("\x1b[38;2;255;20;147m "+Fore.LIGHTWHITE_EX+"time(s) "+Fore.RED+": "+Fore.LIGHTGREEN_EX)
...
def help():
    ...
    stdout.write("             "+Fore.RED           +"  ██╔═██╗ ██╔══██╗██╔══██║██╔═██╗ ██╔══╝  ██║╚██╗██║  \n")
    stdout.write("             "+Fore.RED           +"  ██║  ██╗██║  ██║██║  ██║██║  ██╗███████╗██║ ╚████║  \n")
    stdout.write("             "+Fore.RED           +"  ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═══╝  v1.0\n")
    stdout.write("             "+Fore.RED           +"     Developed solely by void. (t.me/ServerKillers)           \n")
    stdout.write("             "+Fore.RED           +"        ══╦═════════════════════════════════╦══\n")
    stdout.write("             "+Fore.RED           +"╔═════════╩═════════════════════════════════╩═════════╗\n")
    ...
    stdout.write("             "+Fore.RED           +"║ \x1b[38;2;255;20;147m "+Fore.LIGHTWHITE_EX+"info     "+Fore.RED+"|"+Fore.LIGHTWHITE_EX+" Show information                        "+Fore.RED+"║\n")
    stdout.write("             "+Fore.RED           +"║ \x1b[38;2;255;20;147m "+Fore.LIGHTWHITE_EX+"Telegram "+Fore.RED+"|"+Fore.LIGHTWHITE_EX+" https://t.me/ServerKillers              "+Fore.RED+"║\n")
    stdout.write("             "+Fore.RED           +"║ \x1b[38;2;255;20;147m "+Fore.LIGHTWHITE_EX+"github   "+Fore.RED+"|"+Fore.LIGHTWHITE_EX+" github.com/ServerKillers/Kraken         "+Fore.RED+"║\n")
    stdout.write("             "+Fore.RED           +"╚═════════════════════════════════════════════════════╝\n")
##############################################################################################
def credit():
    stdout.write("\x1b[38;2;255;20;147 "+Fore.LIGHTWHITE_EX   +"Developer "+Fore.RED+": \x1b[38;2;0;255;189mVoid\n")
    stdout.write("\x1b[38;2;255;20;147 "+Fore.LIGHTWHITE_EX   +"UI Design "+Fore.RED+": \x1b[38;2;0;255;189mVoid\n")
    stdout.write("\x1b[38;2;255;20;147 "+Fore.LIGHTWHITE_EX   +"Methods/Tools "+Fore.RED+": \x1b[38;2;0;255;189mVoid\n")
    stdout.write("\n")    
##############################################################################################
def layer7():
    clear()
    ...
    stdout.write("             "+Fore.RED             +"        ══╦═════════════════════════════════╦══        \n")
    stdout.write("            "+Fore.RED            +"╔══════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("            "+Fore.RED            +"║ \x1b[38;2;255;20;147m"+Fore.LIGHTWHITE_EX+"bypass "+Fore.RED+" |"+Fore.LIGHTWHITE_EX+" Bypass CF Attack                           "+Fore.RED+"║\n")                 
    stdout.write("            "+Fore.RED            +"║ \x1b[38;2;255;20;147m"+Fore.LIGHTWHITE_EX+"flood  "+Fore.RED+" |"+Fore.LIGHTWHITE_EX+" HTTP Flood Attack                          "+Fore.RED+"║\n")
    stdout.write("            "+Fore.RED            +"║ \x1b[38;2;255;20;147m"+Fore.LIGHTWHITE_EX+"httpx  "+Fore.RED+" |"+Fore.LIGHTWHITE_EX+" HTTP Request Attack                        "+Fore.RED+"║\n")
...
def title():
    ...
    stdout.write("             "+Fore.RED            +"        ══╦═════════════════════════════════╦══\n")
    stdout.write("             "+Fore.RED+"╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("             "+Fore.RED+"║ "+Fore.LIGHTWHITE_EX   +"              Please don't attack !!!  "+Fore.RED  +"             ║\n")
    stdout.write("             "+Fore.RED+"║ "+Fore.LIGHTWHITE_EX   +"      Russian Govenrement sites and .ru domains"+Fore.RED +"     ║\n")
    stdout.write("             "+Fore.RED+"║ "+Fore.LIGHTWHITE_EX   +"             Telegram: @ServerKillers"+Fore.RED +"               ║\n")
    stdout.write("             "+Fore.RED+"╚═════════════════════════════════════════════════════╝\n") 
    stdout.write("\n")
##############################################################################################
def command():
    ...
    if command == "cls" or command == "clear":
        ...
        timer.join()
    elif command == "flood" or command == "flood":
        target, thread, t = get_info_l7()
...
def func():
    ...
    stdout.write(Fore.LIGHTWHITE_EX+"post       "+Fore.RED+": "+Fore.LIGHTWHITE_EX+"Post Request attack\n")
    stdout.write(Fore.LIGHTWHITE_EX+"head       "+Fore.RED+": "+Fore.LIGHTWHITE_EX+"Head Request attack\n")
    stdout.write(Fore.LIGHTWHITE_EX+"soc        "+Fore.RED+": "+Fore.LIGHTWHITE_EX+"Socket attack\n")
###################################################################################################################
    stdout.write(Fore.RED+" \n[\x1b[38;2;0;255;189mTOOLS"+Fore.RED+"]\n")
    stdout.write(Fore.LIGHTWHITE_EX+"dns        "+Fore.RED+": "+Fore.LIGHTWHITE_EX+"Classic DNS Lookup\n")
    stdout.write(Fore.LIGHTWHITE_EX+"geoip      "+Fore.RED+": "+Fore.LIGHTWHITE_EX+"Geo IP Address Lookup\n")
    stdout.write(Fore.LIGHTGREEN_EX+"subnet     "+Fore.RED+": "+Fore.LIGHTWHITE_EX+"Subnet IP Address Lookup\n")
    
    stdout.write(Fore.RED+" \n[\x1b[38;2;0;255;189mOTHER"+Fore.RED+"]\n")
    stdout.write(Fore.LIGHTWHITE_EX+"clear/cls  "+Fore.RED+": "+Fore.LIGHTWHITE_EX+"Clear console\n")
    stdout.write(Fore.LIGHTWHITE_EX+"exit       "+Fore.RED+": "+Fore.LIGHTWHITE_EX+"Bye..\n")
    stdout.write(Fore.LIGHTWHITE_EX+"info     "+Fore.RED+": "+Fore.LIGHTWHITE_EX+"Thanks for\n")
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        ...
        stdout.write("Method: bypass, flood, httpx, get, post, head, soc,\n")
    ...
    if method == "bypass":
        ...
        stdout.write("No method found.\nMethod: bypass, flood, httpx, get, post, head, soc,\n")